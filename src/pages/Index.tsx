              ...
              <form onSubmit={handleSubmit} className="card-glass rounded-2xl p-8 md:p-10">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button type="button" onClick={(e) => handleSubmit(e, "whatsapp")}
                    className="flex items-center gap-2 border-2 border-orange-500/50 text-foreground font-display font-bold px-8 py-4 rounded-full hover:border-orange-500 hover:text-orange-500 transition-all text-lg">
